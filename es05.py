...
try:
	...
	if n < 0:
		...
		while div <= n/2 and flag==0:				# as long as the divisor is smaller than half the number entered and flag is zero
			if n%div==0:					# if a divisor that gives zero remainder has been found
